...
python ./execute_object_detection.py --model faster --video ../../datasets/jodoin/rouen_video.avi --transformations rot270 --output ../output/rouen/ann/faster/annotations.json --print_output_folder ../output/rouen/images/faster
...
python ./execute_object_detection.py --model yolo --video ../../datasets/jodoin/rouen_video.avi --transformations rot90 --output ../output/rouen/ann/yolo/annotations.json --print_output_folder ../output/rouen/images/yolo
